...
BUTTON_LOCATOR = MainPageBannerLocators.START_TRADING_BUTTON_INDUSTRY_LEADING_SUPPORT_TAB_V2


class IndustryLeadingSupportBannerStartTradingButtonV2(BasePage):
    global BLOCK_NAME
    global BANNER_NAME
    global BUTTON_NAME
