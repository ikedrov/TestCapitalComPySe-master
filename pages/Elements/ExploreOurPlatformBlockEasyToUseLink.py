...
BUTTON_NAME = '[easy-to-use]'
BLOCK_NAME = '"Explore our platform"'
BUTTON_LOCATOR = ContentBlockLocators.EASY_TO_USE_LINK_EXPLORE_OUR_PLATFORM_BLOCK
BLOCK_LOCATOR = ContentBlockLocators.EXPLORE_OUR_PLATFORM_BLOCK


class ExploreOurPlatformBlockEasyToUseLink(BasePage):
    global BUTTON_NAME
    global BLOCK_NAME
