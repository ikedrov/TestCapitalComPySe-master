...
TAB_LOCATOR = MainPageBannerLocators.GET_INVOLVED_TAB_MAIN_PAGE_BANNER_V2
BUTTON_LOCATOR = MainPageBannerLocators.TRADE_NOW_BUTTON_GET_INVOLVED_TAB_V2


class GetInvolvedBannerPracticeForFreeButtonV2(BasePage):
    global BLOCK_NAME
    global BANNER_NAME
    global BUTTON_NAME
