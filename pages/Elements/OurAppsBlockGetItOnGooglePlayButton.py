...
BUTTON_NAME = '[Get it on Google Play]'
BLOCK_NAME = '"Our Apps"'
BUTTON_LOCATOR = OurAppsBlock.GET_IT_ON_GOOGLE_PLAY_BUTTON_OUR_APPS_BLOCK
BLOCK_LOCATOR = OurAppsBlock.OUR_APPS_BLOCK


class OurAppsBlockGetItOnGooglePlayButton(BasePage):
    global BUTTON_NAME
    global BLOCK_NAME
