...
BANNER_NAME = "Industry-leading support for new traders."
BUTTON_NAME = '[Practice for free]'

BLOCK_LOCATOR = MainPageBannerLocators.MAIN_PAGE_BANNER_BLOCK_V2
TAB_LOCATOR = MainPageBannerLocators.INDUSTRY_LEADING_SUPPORT_TAB_MAIN_PAGE_BANNER_V2
BUTTON_LOCATOR = MainPageBannerLocators.PRACTICE_FOR_FREE_BUTTON_INDUSTRY_LEADING_SUPPORT_TAB_V2


class IndustryLeadingSupportBannerPracticeForFreeButtonV2(BasePage):
    global BLOCK_NAME
    global BANNER_NAME
    global BUTTON_NAME
    ...
    def full_test_with_tpi(self, d, cur_language, cur_country, cur_role, cur_item_link):
        ...
        match cur_role:
            ...
            case "Auth":
                test_element.assert_trading_platform_v4(d, cur_item_link, True, False)
