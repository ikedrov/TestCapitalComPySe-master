...
BANNER_NAME = "Find us on Tradingview"
BUTTON_NAME = '[Explore features]'

BLOCK_LOCATOR = MainPageBannerLocators.MAIN_PAGE_BANNER_BLOCK
TAB_LOCATOR = MainPageBannerLocators.FIND_US_ON_TRADINGVIEW_TAB_MAIN_PAGE_BANNER
BUTTON_LOCATOR = MainPageBannerLocators.EXPLORE_FEATURES_BUTTON_FIND_US_ON_TRADINGVIEW_TAB


class FindUsOnTradingviewBannerExploreFeaturesButton(BasePage):
    global BLOCK_NAME
    global BANNER_NAME
    global BUTTON_NAME
