...
class GlobalEnvironmentalStartTradingButton(BasePage):

    @allure.step('Start Full test for Start trading button of Global Environmental')
    ...
    def arrange_(self, d, cur_item_link, always=False):
        ...
        button_list = self.driver.find_elements(*GlobalEnvironmentalLocators.BUTTON_START_TRADING)
    ...
    @allure.step("Click button [Start Trading] on Global Environmental")
