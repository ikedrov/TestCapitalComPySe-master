...
BUTTON_LOCATOR = MainPageBannerLocators.TRY_FREE_DEMO_BUTTON_GET_INVOLVED_TAB


class GetInvolvedBannerTryFreeDemoButton(BasePage):
    global BLOCK_NAME
    global BANNER_NAME
    global BUTTON_NAME
