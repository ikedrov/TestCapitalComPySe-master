...
#         button = self.driver.find_element(*OnTrastLocators.BUTTON_ACCEPT_ALL_COOKIE)
...
#             loc_button = self.driver.find_element(*WidgetStillLookingFor.BUT_CREATE_YOUR_ACCOUNT_EN)
#             self.driver.execute_script(
#                 'return arguments[0].scrollIntoView({block: "center", inline: "nearest"});',
#                 loc_button
#             )
...
#             assert loc_return, "Widget 'Still looking for a broker ...' are not present on this page"
#             loc_button = self.driver.find_element(*WidgetStillLookingFor.BUT_CREATE_YOUR_ACCOUNT_DE)
#             self.driver.execute_script(
#                 'return arguments[0].scrollIntoView({block: "center", inline: "nearest"});',
#                 loc_button
#             )
...
#             button = self.driver.find_element(*WidgetExploreOurPlatform.BUTTON_TRY_NOW_EN)
#         elif language not in [""]:
#             button = self.element_is_present(*WidgetExploreOurPlatform.BUTTON_TRY_NOW_DE)
#             assert button, "Widget 'Explore our platform' are not present on this page"
#             button = self.driver.find_element(*WidgetExploreOurPlatform.BUTTON_TRY_NOW_DE)
#
#         self.driver.execute_script(
#             'return arguments[0].scrollIntoView({block: "center", inline: "nearest"});',
#             button
...
#         list_buttons = self.driver.find_elements(*BannerNewToTradingDe.BUTTON_PRACTISE_FOR_FREE)
...
#             )
#         elif language not in [""]:
#             button = self.driver.find_element(*WidgetNewToTrading.BUTTON_PRACTISE_FOR_FREE_DE)
#             self.driver.execute_script(
#                 'return arguments[0].scrollIntoView({block: "center", inline: "nearest"});',
#                 button
#             )
